        ...
        <div className="left-nav col-lg-3">
            <div className="left-nav__container pt-5 d-flex flex-column col-lg-3">
                <ul className="list-unstyled">
                    ...
                    <Link to="/manuscripts"><li className="left-nav__container--item">Научный самоанализ</li></Link>
                    <Link to="/manuscripts"><li className="left-nav__container--item">Контакты коллег</li></Link>
                    <Link to="/manuscripts"><li className="left-nav__container--item">Научный коллектив</li></Link>
                    <Link to="/diary"><li className="left-nav__container--item">Личный дневник</li></Link>
                    <Link to="/manuscripts"><li className="left-nav__container--item">Мультимедийные факты</li></Link>
                </ul>
            </div>
        </div>
    );
