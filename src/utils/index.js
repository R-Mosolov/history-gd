...
var getLabelById = function (id, obj) {
    return obj.find(function (item) { return item.id === id; }).label;
};
var getPlaceholderById = function (id, obj) {
    return obj.find(function (item) { return item.id === id; }).placeholder;
};
var getRequiredById = function (id, obj) {
    return obj.find(function (item) { return item.id === id; }).isRequired;
};
