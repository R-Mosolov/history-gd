...
export default function Dropzone(props) {
  ...
  const createDroppedFile = () => {
    ...
    storage.createManuscriptContentFile(`${Date.now()}`, fileInBlob, fileType, fileExtension);
  };

  return (
    <section className="container dropzone-field">
      <div {...getRootProps({ className: 'dropzone' })}>
        ...
        <p>
          Принимается <b>только 1 файл</b> в следующем формате: <b>DOCX</b>, <b>PDF</b> или <b>PPTX</b>.
        </p>
      </div>
      <aside>
        <ul>{files}</ul>
