        ...
        <div className="source-handling col-lg-9">
          <div className="container">
            ...
            <div className="source-handling__description mt-5 p-5 text-justify bg-light rounded">
              ...
              что все представленные здесь сервисы являются, в основном,
              внешними и бесплатными. Администрация сайта не несёт
              ответственности за их использование. Также мы настоятельно не
              рекомендуем использовать их в коммерческих целях, поскольку
              бесплатные сервисы опасны тем, что всегда есть вероятность утечки
            ...
            <div className={`source-handling__services ${marginTopFive}`}>
              ...
              <h4 className={`${marginTopFour}`}>
                <a
                  href="http://ru.texthandler.com/text-tools/remove-line-breaks/"
                  target="__blank"
                >
              ...
              <p className="text-justify">
                ...
                символов, которые невозможно прочитать, то, вероятнее всего, в
                таких случаях Вам будет полезен декодер текста, переводящий его
              ...
              <p className="text-justify">
                Сервис позволяет автоматически перекодировать символы с
                кириллицы на символы латиницы, что может пригодиться, например,
                при подготовки рукописи, в особобенности раздела с англоязычными
                источниками (References). При перекодировке символов сервис
                опирается на международный стандарт «Library of Congress».
              </p>
              ...
              <p className="text-justify">
                Сервис является аналогом бумажного переводчика на иностаранные
                языки и имеет большой корпус текстов. Предпочтителен для
                перевода отдельных слов. Дополнительным преимуществом является
                то, что сервис позволяет видеть наиболее устойчивые выражения в
                тексте, например, на английском языке.
              </p>
              ...
              <p className="text-justify">
                Сервис является аналогом бумажного переводчика на иностаранные
                языки, но, в отличие от вышеупомянутого сервиса (ABBYY Lingvo
                Live), более предпочтителен для перевода целых предложений и
                абзацев. Качество переводов, как правило, является несколько
                лучше, чем в Google Translator.
              </p>

              <h4 className={`${marginTopFour}`}>
                <a
                  href="https://www.gingersoftware.com/grammarcheck"
                  target="__blank"
                >
                  2.4 Ginger Grammar Checker: Проверить грамматику иностранного
                  текста
                </a>
              </h4>
              <p className="text-justify">
                Сервис позволяет проверить, правильно ли, с грамматической точки
                зрения, был построен текст, учитывая диалект. В основном, хорошо
                подходит только для проверки отдельных предложений.
              </p>
              ...
              <h4 className={`${marginTopFour}`}>
                <a
                  href="https://bradtraversy.github.io/type-n-speak/"
                  target="__blank"
                >
              ...
              <p className="text-justify">
                Пожалуй, это одна из наиболее ценных технологий, которая
                используется нами уже на протяжении минимум последнего года
                (2020-2021 гг.), поскольку она позволяет в 1,5-2 раза экономить
                исследовательские часы на изучении вторичных источников. Дело в
                том, что в аудиоформате (речь о т.н. «аудиокнигах») обычно
                хранятся преимущественно книги художественного и
                научно-популярного характера. С помощью же данной технологии
                можно переводить в аудиоформат в том числе научные публикации,
                тезисы конференций и монографии, слушая их по дороге куда-либо,
                например, по пути из дома в университет и обратно и в перерывах
                между лекциями.
              </p>
              ...
              <h4 className={`${marginTopFour}`}>
                <a
                  href="http://vkmate.ru/servisy/sohranenie-steny-vkontakte/"
                  target="__blank"
                >
